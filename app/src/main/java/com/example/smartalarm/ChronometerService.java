...
public class ChronometerService extends Service {
    public static final String TYPE_OF_SERVICE = "ServiceType";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        String serviceType = intent.getStringExtra(TYPE_OF_SERVICE);
        ...
        if (chronometerBase!=0) {
            ...
            chronometerIntent.putExtra(TYPE_OF_SERVICE,50);
